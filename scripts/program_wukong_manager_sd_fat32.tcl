...
set bitfile [file join $repo build wukong-manager-sd-fat32 wukong_manager_sd_fat32.bit]
if {![file exists $bitfile]} { error "Missing bitstream: $bitfile" }

# Volatile JTAG configuration only: do not write the board's SPI flash while
# qualifying a standalone management image.
open_hw_manager
connect_hw_server
open_hw_target
