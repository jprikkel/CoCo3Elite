...
try {
 & "$VivadoBin\xvlog.bat" -d NEW_SRAM "$repoRoot\rtl\core\coco3_128k_ram.v" "$repoRoot\rtl\core\coco3_char_rom.v" "$repoRoot\rtl\third-party\coco3fpga\coco3vid.v" "$repoRoot\tb\native_text_fetch_tb.v"
