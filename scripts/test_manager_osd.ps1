...
try {
    ...
    if(-not(Select-String -LiteralPath xsim.log -SimpleMatch 'PASS: sentence-case OSD with RGB logo and amber reverse-video selection')){throw 'manager OSD regression did not report PASS'}
