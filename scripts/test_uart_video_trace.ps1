...
try {
 ...
 if($LASTEXITCODE -or -not(Select-String -Path xsim.log -SimpleMatch 'PASS: UART emits complete 119-byte PC/SD/video/MMU snapshot')){throw 'UART regression failed'}
