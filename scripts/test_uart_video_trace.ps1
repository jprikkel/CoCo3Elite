...
try {
 ...
 if($LASTEXITCODE -or -not(Select-String -Path xsim.log -SimpleMatch 'PASS: UART emits complete 130-byte PC/SD/video/MMU/SDRAM snapshot')){throw 'UART regression failed'}
