...
try {
 $sources=@('coco3_128k_ram.v','coco3_system_rom.v','coco3_disk_rom.v','coco3_diagnostic_cartridge.v','coco3_disk_image.v','sd_spi_init.v','sd_spi_read_sector0.v','coco3_fdc.v','coco3_keyboard_matrix.v','coco3_gime_timer.v','coco3_gime_interrupt.v','coco3_boot_machine.v') | ForEach-Object {Join-Path $repoRoot "rtl\core\$_"}
