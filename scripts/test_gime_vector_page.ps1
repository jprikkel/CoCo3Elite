...
try {
 ...
 & (Join-Path $VivadoBin 'xvlog.bat') (Join-Path $repoRoot 'rtl\third-party\MC6809\mc6809i.v') (Join-Path $repoRoot 'rtl\third-party\MC6809\cpu09.v'); if($LASTEXITCODE){throw 'xvlog failed'}
