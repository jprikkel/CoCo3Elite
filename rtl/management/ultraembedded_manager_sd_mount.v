...
module ultraembedded_manager_sd_mount (
    ...
    input wire [1:0] fdc_drive, input wire [7:0] fdc_track, input wire [7:0] fdc_sector, input wire [7:0] fdc_last_type1, input wire [31:0] fdc_debug_word, input wire [31:0] fdc_completed_debug_word, input wire fdc_read_complete_toggle,
    ...
    output wire fdc_success, output wire [2:0] fdc_present, output wire manager_ready
);
