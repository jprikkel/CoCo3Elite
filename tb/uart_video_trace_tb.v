...
module uart_video_trace_tb;
 ...
 integer i,b;
 always #5 clk=~clk;
 coco3_uart_debug dut(.clock(clk),.reset(reset),
 .trace_periodic_enable(trace_periodic_enable),
 .trace_snapshot_toggle(trace_snapshot_toggle),
 .cpu_address(16'd0),.cpu_pc(16'h1234),
