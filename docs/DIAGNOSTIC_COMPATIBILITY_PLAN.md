...
| P1 | Horizontal text clipping | User reports 40-column mode shows 38 characters with the 38th partially clipped; 80-column mode shows 75 characters | All 40 or 80 columns fully visible | Newly reported after scroll-fix validation. Root cause not established. Investigate horizontal active window and the video-to-HDMI mapping; latch tests alone do not prove the entire line reaches the display. |
